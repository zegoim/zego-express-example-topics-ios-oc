...
#ifndef ZGScreenCaptureDefines_h
#define ZGScreenCaptureDefines_h

// Fill in this macro with your customized App Group ID
// Example: #define APP_GROUP @"group.im.zego.express"
#define APP_GROUP @""
...
#endif /* ZGScreenCaptureDefines_h */
