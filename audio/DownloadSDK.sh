...
SDKURL="https://storage.zego.im/express/audio/apple/zego-express-audio-apple.zip"
...
curl "$SDKURL" --output Libs/__sdk_download_tmp__/zego-express-audio-apple.zip

cd Libs/__sdk_download_tmp__
echo "[*] cd into: "`pwd`

echo "[*] Unzip zego-express-audio-apple.zip"
unzip -o zego-express-audio-apple.zip
